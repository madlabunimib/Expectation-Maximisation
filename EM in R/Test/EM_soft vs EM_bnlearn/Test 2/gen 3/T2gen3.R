...
#Initial data
initial_data = data.frame("Data_1" = c(0,1,0,"NA",0), "Data_2" = c("NA",1,0,1,0), "Data_3" = c(1,0,1,0,1), "Data_4" = c(1,"NA",0,0,1),"Data_5" = c(1,0,0,0,"NA"),  row.names = c("A", "B", "C", "D", "E"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(0,1,0,0.5,0), "Data_2" = c(0.5, 1,0,1,0), "Data_3" = c(1,0,1,0,1), "Data_4" = c(1,0.5,0,0,1), "Data_5" = c(1,0,0,0,0.5), row.names = c("A", "B", "C", "D", "E"), stringsAsFactors = TRUE)
#"Data_5" = c(0.5,0,0), "Data_6" = c(0.5,0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,0.5), "Data_10" = c(1,0.5,0), 

bn_data = model2network("[A][B|A][C|A][D|C][E|A:D:B]")
...
C.prob = matrix(c(1/2, 1/2, 2/3, 1/3 ), ncol=2,
                dimnames = list(C = lv, A = lv))
C.prob = matrix(c(2/7, 5/7, 1/2, 1/2 ), ncol=2,
                dimnames = list(C = lv, A = lv))
D.prob = matrix(c(2/3, 1/3, 1/4, 3/4 ), ncol=2,
                dimnames = list(D = lv, C = lv))
E.prob = c(0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8, 0.5, 0.5, 0.35, 0.65, 0.45, 0.55, 0.25, 0.75)
dim(E.prob) = c(2, 2, 2, 2)
dimnames(E.prob) = list(E = lv, D = lv, B = lv, A = lv)
