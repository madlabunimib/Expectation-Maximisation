...
#Initial data
initial_data = data.frame("Data_1" = c(1,1,"NA"), "Data_2" = c("NA",1,1), "Data_3" = c(1,1,1), "Data_4" = c("NA",1,1), "Data_5" = c(1,"NA",1), row.names = c("A", "B", "C"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(1,1,0.5), "Data_2" = c(0.5,1,1), "Data_3" = c(1,1,1), "Data_4" = c(0.5,1,1), "Data_5" = c(1,0.5,1), row.names = c("A", "B", "C"), stringsAsFactors = TRUE)
...
C.prob = matrix(c(0.5, 0.5, 0.6, 0.4 ), ncol=2,
