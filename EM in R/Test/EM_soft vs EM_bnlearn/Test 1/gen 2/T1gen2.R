    ...
    for (factor in nodes(bn)){
      ...
      if (identical(lista_genitori_factor,character(0))){
        ...
        for (x in genitore_factor){
          ...
          list_genitori = c(list_genitori, genitore_observation)
        ...
        #da sistemare
        if (cpt_lenght == 4){
          posterior_0 = posterior_0 * as.numeric(cpt[[factor]][prior_observation[1],list_genitori[1]])
          posterior_1 = posterior_1 * as.numeric(cpt[[factor]][prior_observation[2],list_genitori[2]])
        }
        if (cpt_lenght == 8){
          posterior_0 = posterior_0 * as.numeric(cpt[[factor]][prior_observation[1],list_genitori[3], list_genitori[1]])
          posterior_1 = posterior_1 * as.numeric(cpt[[factor]][prior_observation[2],list_genitori[4], list_genitori[2]])
        }
