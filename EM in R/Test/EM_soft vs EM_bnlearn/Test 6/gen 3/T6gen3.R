...
#Initial data
initial_data = data.frame("Data_1" = c(0,1,1), "Data_2" = c(0,1,0), "Data_3" = c(1,0,"NA"), "Data_4" = c(1,1,0), "Data_5" = c(0,1,1), "Data_6" = c(0,0,0), "Data_7" = c(1,0,"NA"), "Data_8" = c(1,1,1), row.names = c("A", "B", "C"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(0,1,1), "Data_2" = c(0,1,0), "Data_3" = c(1,0,0.5), "Data_4" = c(1,1,0), "Data_5" = c(0,0,1), "Data_6" = c(0,0,0), "Data_7" = c(1,0,0.5), "Data_8" = c(1,1,1), row.names = c("A", "B", "C"), stringsAsFactors = TRUE)
