...
#Initial data
initial_data = data.frame("Data_1" = c("NA",1,0,1,1,1), "Data_2" = c(1,"NA",0,0,0,1), "Data_3" = c(0,1,1,0,1,1), "Data_4" = c("NA",1,1,1,1,0), row.names = c("A", "B", "C","D","E","F"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(0.5,1,0,1,1,1), "Data_2" = c(1,0.5,0,0,0,1), "Data_3" = c(0,1,1,0,1,1), "Data_4" = c(0.5,1,1,1,1,0), row.names = c("A", "B", "C","D","E","F"))
#"Data_5" = c(0.5,0,0), "Data_6" = c(0.5,0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,0.5), "Data_10" = c(1,0.5,0), 

bn_data = model2network("[A][B][C][D][E|A:B:C:D][F|A:D:E]")
...
B.prob = matrix(c(0.6, 0.4), dimnames = list(B = lv))
C.prob = matrix(c(0.35, 0.65), dimnames = list(C = lv))
D.prob = matrix(c(0.4, 0.6), dimnames = list(D = lv))

E.prob = c(0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8,0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8,0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8,0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8)
dim(E.prob) = c(2, 2, 2,2,2)
dimnames(E.prob) = list(E = lv, A = lv, B = lv, C = lv, D = lv)

F.prob = c(0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8,0.5, 0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8)
dim(F.prob) = c(2, 2, 2,2)
dimnames(F.prob) = list(F = lv, A = lv, D= lv, E = lv)

cpt = list(A = A.prob, B = B.prob, C = C.prob, D = D.prob, E = E.prob, F = F.prob)
cpt_last = cpt
