...
expectation_step_soft <- function(missing_data,table_posterior_prob,M.prob,Data,bn,cpt) {
...
maximisation_step_soft <- function(node,bn,table_posterior_prob,Data,cpt,M.prob) {
...
Create_matrix_posterior_prob_soft <- function(missing_data, M.prob,bn) {
...
initialize_matrix_posterior_prob_soft <- function(missing_data, M.prob,table_posterior_prob,bn){
  for (i in missing_data){
...
em_soft <- function(initial_data, structure, cpt, ALPHA=0.05, NUMBER_ITERACTION=100){
  ...
  M.prob = prob_missing_soft(Data,initial_data)
  #Inizio programma
  table_posterior_prob = Create_matrix_posterior_prob_soft(missing_data, M.prob,bn)
  table_posterior_prob = initialize_matrix_posterior_prob_soft(missing_data, M.prob,table_posterior_prob,bn)
  
  
  for (i in 1:NUMBER_ITERACTION) {
    print(i)
    table_posterior_prob = expectation_step_soft(missing_data,table_posterior_prob,M.prob,Data,bn,cpt)
    Data = update_data_soft(missing_data,table_posterior_prob,Data)
    cpt = maximisation_step_soft(node,bn,table_posterior_prob,Data,cpt,M.prob)
