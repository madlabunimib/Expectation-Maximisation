...
#Initial data e creazione delle CPT
initial_data = data.frame("Data_1" = c(1,1,0), "Data_2" = c(0,0,3), "Data_3" = c(2,"NA",2), "Data_4" = c(1,1,"NA"), "Data_5" = c("NA",0,1), "Data_6" = c(0,1,3),row.names = c("A", "B", "C"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(1,1,0), "Data_2" = c(0,0,3), "Data_3" = c(2,0.5,2), "Data_4" = c(1,1,0.5), "Data_5" = c(0.5,0,1), "Data_6" = c(0,1,3),  row.names = c("A", "B", "C"), stringsAsFactors = TRUE)
...
A.prob = matrix(c(0.4,0.3,0.3), dimnames = list(A = c("0", "1", "2")))


B.prob = matrix(c(1/3, 2/3, 2/3, 1/3, 3/4,1/4 ), ncol=3,
               dimnames = list(B = c("0", "1"), A = c("0", "1", "2")))


C.prob = c(0.2,0.2,0.3,0.3,0.4,0.2,0.3,0.1,0.5,0.2,0.1,0.2,0.25,0.1,0.4,0.25,0.3,0.1,0.2,0.4,0.35,0.15,0.25,0.25)
dim(C.prob) = c(4, 2, 3)
dimnames(C.prob) = list(C = c("0", "1","2","3"), B = c("0", "1"), A=c("0","1","2"))
