...
#Initial data
initial_data = data.frame("Data_1" = c(0,1,"NA"), "Data_2" = c(1,1,0), "Data_3" = c("NA",1,1), "Data_4" = c(1,"NA",0), row.names = c("A", "B", "C"))
#, "Data_5" = c("NA",0,0), "Data_6" = c("NA",0,1), "Data_7" = c(1,0,1), "Data_8" = c(1,0,1), "Data_9" = c(1,1,"NA"), "Data_10" = c(1,"NA",0),

#Updates data
Data = data.frame("Data_1" = c(0,1,0.5), "Data_2" = c(1,1,0), "Data_3" = c(0.5,1,1), "Data_4" = c(1,0.5,0), row.names = c("A", "B", "C"), stringsAsFactors = TRUE)
...
C.prob = array(c(1/3, 2/3, 2/3, 1/3 ), dim = c(2, 2),
